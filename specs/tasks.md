...
### Approved execution order: S5 (#2,#3) -> S6 (#4-img,#5,#1-img) -> S7 (#4-label) -> S8 (#6) -> S9 (#1-badge) -> S10 (remove Generate btn in concept panel)
